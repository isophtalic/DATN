...
interface DataTableProps<DataRuleInterface, TValue> {
    columns: ColumnDef<DataRuleInterface, TValue>[]
...
export function DataTable<DataRuleInterface, TValue>({
    columns,
    data,
    secrule_id,
    pagination,
    ...
    const getStyleActionsCell = (cell: Cell<DataRuleInterface, unknown>) => {
        return cell.id.includes("actions") ? "w-[50px]" : ""
    }

    const getStyleUpdatedCell = (cell: Cell<DataRuleInterface, unknown>) => {
