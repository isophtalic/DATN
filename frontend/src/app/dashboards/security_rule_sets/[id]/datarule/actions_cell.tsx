...
const ActionsCell = ({ id, data_id, onDelete }: ActionsCellProps) => {
    ...
    return (
        <div className="flex flex-row justify-end">
            <div onClick={() => onDelete(data_id)} className="cursor-pointer w-10 h-10 flex justify-center rounded-lg hover:bg-sky-500 hover:text-white shadow border hover:border-sky-500">
                <TrashIcon className='w-6 h6' />
            </div>
            <div className="w-5"></div>
            <div onClick={() => viewDetail(id, data_id)} className="cursor-pointer w-10 h-10 flex justify-center rounded-lg hover:bg-sky-500 hover:text-white shadow border  hover:border-sky-500">
