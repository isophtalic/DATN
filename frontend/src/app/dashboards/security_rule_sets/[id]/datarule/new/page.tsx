...
const NewRuleSet = () => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            let res = await DataRuleAPI.newItem(values)
            if (res.success) {
                toast({
                    description: "Created",
                })
            ...
            <div className=''>
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbItem>
                            <BreadcrumbLink href={"/dashboards/ruleset/new"}>Create DataRule</BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            ...
                            <div className='flex flex-row-reverse gap-10'>
                                <div >
                                    <Button className=' transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration:300' style={{ backgroundColor: "rgb(14,165,233)" }} type="submit">Create Data</Button>
                                </div>
                                <div>
