        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="flex flex-row justify-end">
                    ...
                    <Link className="w-10 h-10 flex justify-center rounded-lg hover:bg-sky-500 hover:text-white shadow border  hover:border-sky-500" href={`/dashboards/users/${payment.id}/reset-pass`}>
