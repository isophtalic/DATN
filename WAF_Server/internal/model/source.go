...
type Source struct {
	...
	ProxyID_FK string    `json:"proxy_id,omitempty" gorm:"column:proxy_id;type:uuid;foreignKey:proxy_id;constraint:OnUpdate:CASCADE,OnDelete:SET NULL"`
}

func (s *Source) Valid() bool {
	// TODO: validate domain in hostname
